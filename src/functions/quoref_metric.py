...
from src.functions import drop
...
def _get_answers_from_data(annotations: Dict[str, Any]) -> Dict[str, List[str]]:
    ...
    for article_info in annotations["data"]:
        ...
        for paragraph_info in article_info["paragraphs"]:
            ...
            candidate_answers = [e['answers'][0]['text'] for e in paragraph_info['qas']]
            answers_dict[title] = candidate_answers
    return answers_dict
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default="./finetune/ckpt/quoref_roberta_large_v2/predictions_6400.json",
